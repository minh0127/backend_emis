...
namespace MISA.Web06.API.Controllers
{
    ...
    {
        IEmployeeDepartmentService _service;
        IEmployeeDepartmentRepository _repository;
        public EmployeeDepartmentsController(IEmployeeDepartmentService service, IEmployeeDepartmentRepository repository)
        {
            _service = service;
