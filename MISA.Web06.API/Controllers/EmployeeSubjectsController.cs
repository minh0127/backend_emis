...
namespace MISA.Web06.API.Controllers
{
    ...
    {
        IEmployeeSubjectService _service;
        IEmployeeSubjectRepository _repository;
        public EmployeeSubjectsController(IEmployeeSubjectService service, IEmployeeSubjectRepository repository)
        {
            _service = service;
